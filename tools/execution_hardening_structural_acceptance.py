...
def validate_static_bindings(
    *,
    ...
    kernel: str,
    harness: str,
    material_acceptance: str,
    material_adjudicator: str,
    api_visibility: str,
) -> None:
    for marker in [
        "INTENT_RECEIPT",
        ...
        "IDENTITY READBACK",
        "EFFECT READBACK",
        "INDEPENDENT_EVIDENCE_LINEAGE_COUNT",
        "ROUTE_AUTHORITY != ROUTE_AVAILABILITY",
        "OPERATION_RESOURCE_FOOTPRINT",
        "PARTIALLY_APPLIED",
        "TARGET_COMMITTED",
        "FINAL_THEME_CLOSURE",
        "FAILURE_FAMILY_ID",
        "WHY UNKNOWN",
        "Cross-guard precedence",
    ]:
    ...
    for marker in [
        "EXECUTION_HARDENING_TRIALS=75",
        "EXECUTION_HARDENING_VARIANTS_PER_CASE=5",
        "EXECUTION_HARDENING_VARIANT_MODE=MATERIAL_INPUT_VARIATION",
        "EXECUTION_HARDENING_CRITICAL_ERRORS=0",
        "HOST_FRESH_CONTEXT_PROVEN=NO",
    ]:
    ...
    for marker in [
        ...
        "class ExecutionNode",
        "def classify_material_graph",
        "def execution_graph_digest",
        "MATERIAL_PRIMITIVES",
    ...
    for marker in [
        ...
        "material-predicate-acceptance-receipt/v1",
        "API_VISIBILITY_NOT_PASS",
        "API_VISIBILITY_COMMIT_MISMATCH",
    ]:
        require(material_adjudicator, marker, str(MATERIAL_ADJUDICATOR))

    for marker in [
        "PLATFORM_TRUST_ASSUMPTION_GITHUB_CONTROL_PLANE",
        "PAGINATION_INCOMPLETE",
        "RUNWIDE_ATTEMPT_UNIVERSE_MISMATCH",
        "CANARY_COUNT",
...
def main() -> None:
    ...
    validate_static_bindings(
        ...
        material_adjudicator=material_adjudicator,
